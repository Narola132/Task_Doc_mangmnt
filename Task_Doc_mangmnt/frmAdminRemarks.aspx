<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="frmAdminRemarks.aspx.cs" Inherits="Task_Doc_mangmnt.frmAdminRemarks" %>
                    ...
                    <table border="0" width="100%" style="margin-top: 10px">
                        <tr>
                            <td class="form-group row"><b>Remarks :</b><br />
                                <asp:TextBox ID="txtrks" runat="server" class="form-control" Width="350" TextMode="MultiLine"></asp:TextBox><br />
