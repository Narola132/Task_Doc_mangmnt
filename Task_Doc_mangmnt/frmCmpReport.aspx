<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="frmCmpReport.aspx.cs" Inherits="Task_Doc_mangmnt.frmUserReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <a href="#modal-table" role="button" class="blue" data-toggle="modal">User </a>
                ...
                <div class="col-xs-12 col-sm-8" style="margin-left: 150px; width: 600px;">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <asp:LinkButton ID="btnsrsdnt" runat="server" OnClick="btnsrsdnt_Click" class="btn btn-purple btn-sm " style="margin-right:20px; height:35px;">
    ...
    <br />   <asp:GridView ID="gridreg" runat="server" AutoGenerateColumns="false" OnPageIndexChanging="gridreg_PageIndexChanging" AllowPaging="true" PageSize="10" CssClass="table table-striped table-bordered datatable" >
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Email">
                <ItemTemplate>
                   <span class="detail-col"><%# Eval("Email") %></span>
                </ItemTemplate>
            </asp:TemplateField>

             <asp:TemplateField  HeaderText="Contact Person Name">
                <ItemTemplate>
                   <span class="detail-col"><%# Eval("ContactPersonName") %></span>
                </ItemTemplate>
              </asp:TemplateField>   
                ...
                <ItemTemplate>
                   <span class="detail-col"><%# Eval("ContactPhone") %></span>
                </ItemTemplate>    
            </asp:TemplateField>
             ...
             <asp:TemplateField  HeaderText="Contact Email">
                <ItemTemplate>
                   <span class="detail-col"><%# Eval("ContactEmail") %></span>
                </ItemTemplate>    
            </asp:TemplateField>
