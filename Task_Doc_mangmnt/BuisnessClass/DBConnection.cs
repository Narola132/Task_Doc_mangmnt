...
using System.Web;
    ...
    public class DBConnection
    {
        ...
        public DBConnection()
        {
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["DocumentConStr"].ToString());
        }
        ...
        public static int SendMail(string toaddress, string subject, string strHTML)
        {
            ...
            try
            {
                MailAddress fromAddress = new MailAddress("shraddhanarola@gmail.com","Forgot PAssword");
                ...
                smtpClient.Credentials = new System.Net.NetworkCredential("shraddhanarola@gmail.com","narola231");
